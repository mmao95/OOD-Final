...
public class TestCourse {
    public static void main(String[] args) {
        ...
        GraduateStudent s2 = new GraduateStudent("U002",name2,"002@bu.edu");
        ...
        //UndergradStudent a = (UndergradStudent) c1.getStudent("U001");

        for (Map.Entry<Student, Grade> entry : c1.getCgrade().entrySet()){
            System.out.println("test: " + entry.getKey().getId());
        }
